...
app = FastAPI(title="L.A. Technische Service API")
...
@api_router.get("/")
async def root():
    return {"message": "L.A. Technische Service API"}
...
async def create_contact(payload: ContactCreate):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Kon bericht niet opslaan")
    return obj
